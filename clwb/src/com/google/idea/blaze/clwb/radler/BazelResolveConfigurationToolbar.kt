...
private class BazelConfigSwitchComboAction(
  ...
  private val scope: CoroutineScope = pluginProjectScope(project).childScope(BazelResolveConfigurationWidgetProvider::class)
  ...
  private fun findSelectedConfiguration(configurations: List<SwitcherConfig>): SwitcherConfig {
    ...
    val priorityConfig = OCResolveContextSettings.getInstance(project).findPriorityConfiguration(mapping.keys)
