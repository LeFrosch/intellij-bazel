...
public class ArmToolchainTest extends ClwbHeadlessTestCase {
  ...
  // Bazel 7 fails with an internal crash:
  ...
  @Rule
  public final BazelVersionRule minBazelRule = BazelVersionRule.min(8, 0);

  // toolchains_arm_gnu does not support Bazel 9+ yet
  @Rule
  public final BazelVersionRule maxBazelRule = BazelVersionRule.max(9, 0);
